...
<body>
    <div class="box">
        <h1>Formulário PHP com Sessão</h1>
    ...
    if (!empty($_SESSION['cadastros'])) {
        echo "<div class='box2'><table style='width:100%'>
                <tr>
                    <th>Nome</th><th>CPF</th><th>Data Nascimento</th><th>Email</th><th>Telefone</th><th>Gênero</th>
                </tr>";

        foreach ($_SESSION['cadastros'] as $info) {
            echo "<tr>
                    <td>{$info['nome']}</td>
                    <td>{$info['cpf']}</td>
